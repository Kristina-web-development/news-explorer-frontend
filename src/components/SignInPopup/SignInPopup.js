  ...
  return (
    ...
    >
      <fieldset className="signin-form__fieldset">
        <label className="signin-form__lable signin-form__label_email">
          Email
        </label>
        <input
          className={`signin-form__input ${showErrorInputClass}`}
          type="email"
          ...
          required
        />
        <span className={`signin-form__input-error  ${showErrorMessageClass}`}>
          {errors.email}
        </span>
        <label className="signin-form__lable signin-form__lable_password">
          Password
        </label>
        <input
          className={`signin-form__input ${showErrorInputClass}`}
