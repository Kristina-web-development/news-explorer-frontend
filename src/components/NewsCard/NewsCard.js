            ...
            {!isLoggedIn ? (
                <li className='element'>
                    ...
                    <div className='element__textcontainer'>
                        ...
                        <h3 className='element__title'>Grand Teton Renews Historic Crest Trail</h3>
                        <p className='element__text'>“The linking together of the Cascade and Death Canyon trails, at their heads, took place on October 1, 1933, and marked the first step in the realization of a plan whereby the hiker will be...</p>
